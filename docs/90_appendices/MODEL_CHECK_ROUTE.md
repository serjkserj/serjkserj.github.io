...
Если схема не помещается по ширине страницы, ее можно прокручивать горизонтально. Для очень длинных маршрутов лучше не ужимать диаграмму до нечитаемого состояния, а либо делить ее на 2-3 схемы, либо оставлять в раскрывающемся блоке.
