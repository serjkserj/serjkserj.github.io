...
- Начать различать тело документа, приложения и рабочие таблицы
...
- Собрать свой первый список документов, приложений и правил именования
...
- Уметь переводить требование к `IFC`, атрибуту или пакету в чек-лист или карту параметров
...
- Уметь спокойно работать с приложениями, атрибутивными таблицами и комплектом цифровой передачи
...
- Я умею быстро найти, где именно в документе или приложении живет нужное требование?
