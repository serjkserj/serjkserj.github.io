...
- как будет проверяться исправление.[^m11-remarks-basis]
...
Формат передачи замечания здесь вторичен, но не случаен. На проекте оно может жить в письме, таблице, трекере задач или `BCF`. Важно не столько имя инструмента, сколько то, сохраняются ли адресность, привязка к месту в модели, ссылка на требование и статус повторной проверки.[^m11-remarks-flow]
...
[^m11-remarks-basis]: Опора: [AGR-IFC-2026 — Требования к IFC-материалам для АГР](../90_appendices/DOCUMENT_REFERENCE_CARDS.md#agr-ifc-2026), [EXP-CIM-GENERAL-2025 — Общие требования к ЦИМ. Редакция 5.0](../90_appendices/DOCUMENT_REFERENCE_CARDS.md#exp-cim-general-2025), [EXP-CIM-MSSK-THEMATIC-PACK-2025 — Пакет «ЦИМ и МССК»](../90_appendices/DOCUMENT_REFERENCE_CARDS.md#exp-cim-mssk-thematic-pack-2025).
[^m11-remarks-flow]: Опора: [BIM-NANOSOFT-2025 — BIM-стандарт Нанософт 2025](../90_appendices/DOCUMENT_REFERENCE_CARDS.md#bim-nanosoft-2025), [AGR-ARCHCOMM-PROCEDURE-2026 — Публичная страница Архкомиссии](../90_appendices/DOCUMENT_REFERENCE_CARDS.md#agr-archcomm-procedure-2026).
