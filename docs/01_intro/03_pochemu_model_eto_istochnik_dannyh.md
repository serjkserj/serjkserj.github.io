...
Это одна из главных опор всего handbook. Если ее не собрать в самом начале, дальше `IFC`, параметры, зоны, `ТЭП`, `АГР` и экспертиза будут восприниматься как набор отдельных тем.
