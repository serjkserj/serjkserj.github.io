  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        title: 'ATR BIM Docs',
        logo: {
          alt: 'ATR BIM Documentation Logo',
          src: 'img/logo.svg',
        },
        items: [
          {
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} ATR BIM Documentation. Built with Docusaurus.`,
      },
      prism: {
